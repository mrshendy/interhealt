                    ...
                    <div class="table-responsive" style="overflow: visible;">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0" style="width: 35%;max-width: 100px;">{{ trans('City_trans.teble_Countries') }}</th>
                                <th class="border-bottom-0" style="width: 35%;max-width: 100px;">{{ trans('City_trans.teble_Governmentes') }}</th>
                                <th class="border-bottom-0" style="width: 35%;max-width: 100px;">{{ trans('City_trans.tabel_name') }}</th>
                                <th class="border-bottom-0" style="width: 35%;max-width: 120px;">{{ trans('City_trans.tabel_note') }}</th>
                                <th class="border-bottom-0" style="width: 5%;max-width: 50px;">{{ trans('City_trans.tabel_action') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $i=0; ?>

						...
						<ul class="nav">
							...
							<li class="">
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
									...
									<a rel="alternate" hreflang="{{ $localeCode='en' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode='en', null, [], true) }}" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    @else
                                    <a rel="alternate" hreflang="{{ $localeCode='ar' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode='ar', null, [], true) }}" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egp_ar_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
											<strong class="mr-2 ml-2 my-auto">French</strong>
										</div>
									</a>
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										...
										<a rel="alternate" hreflang="{{ $localeCode='ar' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode='ar', null, [], true) }}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egp_ar_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2"> {{ trans('main_trans.lang_ar') }}</span>
											</div>
										</a>
                                        @else
                                        <a rel="alternate" hreflang="{{ $localeCode='en' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode='en', null, [], true) }}" class="dropdown-item d-flex ">
											<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/us_flag.jpg')}}" alt="img"></span>
											<div class="d-flex">
												<span class="mt-2">{{ trans('main_trans.lang_en') }}</span>
											</div>
										</a>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i>{{ trans('main_trans.logout') }}</a>
